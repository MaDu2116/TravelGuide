...
<body>
    ...
    <header class="header_area">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <a class="navbar-brand logo_h" href="home"><img src="Content/image/Logo.png" alt=""></a>
	...
	<script
		src="ontent/vendors/bootstrap-datepicker/bootstrap-datetimepicker.min.js"></script>
	<script
		src="/Content/vendors/nice-select/js/jquery.nice-select.js"></script>
	<script src="Content/js/mail-script.js"></script>
...
<!-- Mirrored from localhost:2012/Home/DetailTravel/1 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Feb 2022 14:23:02 GMT -->
</html>