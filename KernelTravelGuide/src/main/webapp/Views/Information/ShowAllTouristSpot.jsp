			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<div class="collapse navbar-collapse offset"
					...
					<ul class="nav navbar-nav menu_nav ml-auto">
						...
						<li class="nav-item submenu dropdown"><a href="#"
							...
							<ul class="dropdown-menu">
								<li class="nav-item"><a class="nav-link"
									href="ShowAllTouristSpot.html">Tourist Spots</a></li>
								<li class="nav-item"><a class="nav-link"
									href="ShowAllHotel.html">Hotel</a></li>
								<li class="nav-item"><a class="nav-link"
									href="ShowAllRestaurant.html">Restaurant</a></li>
								<li class="nav-item"><a class="nav-link"
									href="ShowAllResort.html">Resort</a></li>
								<li class="nav-item"><a class="nav-link"
									href="ShowAllTravel.html">Travel</a></li>
							</ul></li>
						...
						<li class="nav-item"><a class="nav-link"
							href="../Account/Register.html">Register</a></li>
						<li class="nav-item"><a class="nav-link"
							href="../Account/Login.html">Login</a></li>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-footer-widget instafeed">
						...
						<ul class="list_style instafeed d-flex flex-wrap">
							<li><img src="../Content/image/instagram/Image-01.jpg"
								alt=""></li>
							<li><img src="../Content/image/instagram/Image-02.jpg"
								alt=""></li>
							<li><img src="../Content/image/instagram/Image-03.jpg"
								alt=""></li>
							<li><img src="../Content/image/instagram/Image-04.jpg"
								alt=""></li>
							<li><img src="../Content/image/instagram/Image-05.jpg"
								alt=""></li>
							<li><img src="../Content/image/instagram/Image-06.jpg"
								alt=""></li>
							<li><img src="../Content/image/instagram/Image-07.jpg"
								alt=""></li>
							<li><img src="../Content/image/instagram/Image-08.jpg"
								alt=""></li>
						</ul>
					</div>
				</div>
