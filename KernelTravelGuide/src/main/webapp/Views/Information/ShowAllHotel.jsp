				...
				<div class="col-lg-8">
								...
								<div class="col-md-3">
									<div class="blog_info text-right">
										<ul class="blog_meta list_style">
											<c:if test="${hotel.available eq 1}">
												<li><a href="#"><div class="btn btn-success">Available</div></a></li>
											</c:if>
											</li>
											<li><a href="#"><c:out value="${hotel.addressHotel}" /><i
													class="lnr lnr-home"></i></a></li>
											<li><a href="#"><c:out value="${hotel.nameCity}" /><i
													class="lnr lnr-map-marker"></i></a></li>
											<li><a href="#">1.2M Views<i class="lnr lnr-eye"></i></a></li>
											<li><a href="#"><c:out value="${hotel.qualityHotel}" />/
													10<i class="lnr lnr-star"></i></a></li>
											<li><a href="#"><h5>
														$
														<c:out value="${hotel.priceHotel}" />
														<small>/night</small>
													</h5></a></li>
										</ul>
									</div>
					...
					<nav class="blog-pagination justify-content-center d-flex">
						<div class="pagination-container">
							<ul class="pagination">
								<c:url value="showAllHotel" var="myURL">
