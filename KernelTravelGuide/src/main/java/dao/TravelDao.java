...
public class TravelDao extends BaseConnection {
	...
	public List<TravelDto> getAllTravel(int offset) {
		List<TravelDto> travelDtoList = new ArrayList<TravelDto>();
	...
	public int countAllTravel(String searchStr, String city, String quality) {
		int count = 0;
	...
	public List<TravelDto> getAllTravel(int offset, String searchStr, String city, String quality) {
